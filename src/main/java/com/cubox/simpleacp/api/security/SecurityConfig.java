...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity webSecurity) {
        webSecurity.ignoring()
                ...
                .antMatchers("/webjars/**")
                .antMatchers(Constants.API.API_HEALTH)
                .antMatchers(Constants.API.API_PREFIX + Constants.API.API_AUTH + "/**")
                .antMatchers(Constants.API.API_PREFIX + Constants.API.API_CODE + "/**")
                .antMatchers("/api/sync/**")
        ;
    }
